...
/**
 * Plugin class. This class enables the vxlpay plugin, client facing functionality.
 *
 * 
...
class VxlpayWpPlugin {
    ...
    private function __construct() {
        ...
        $this->log('VXLPAYPLUGIN.__Construct', 'Running constructor');
        ...
        if(isset($_POST['submit'])){
            ...
            require_once( plugin_dir_path( __FILE__ ) . '/ClassVxlpayWPPost.php' );

           $this->message ='received rsponse :'.  VxlpayWPPost::doAction($_POST['vxlAction']);
    ...
    public function enqueue_styles() {
         wp_enqueue_style($this->plugin_slug . '-plugin-styles', 'http://vxlpay.appspotlocal.com/vxl/css/VXL.css', array(), self::VERSION);
    }
    ...
    public function enqueue_scripts() {
           wp_enqueue_script($this->plugin_slug . '-VXL_check-script', 'http://vxlpay.appspotlocal.com/vxl/js/VXL_apply.js', array('jquery'), self::VERSION);
           wp_enqueue_script($this->plugin_slug . '-VXL_apply-script', 'http://vxlpay.appspotlocal.com/vxl/js/VXL_check.js', array('jquery'), self::VERSION);
    }
    ...
    *     */
	...
	return  '<div id="trancher_inject">'.$content.'</div>';
    }
	...
	*/
	...
	function frontendHeader() {
        ...
        print stripslashes('
            ...
            <div id="VXL_inject">
               '.VxlpayWpPlugin::getTrinket(get_option('vxlTrinketType')).'
...
window.addEventListener(\'message\',function(event) {
    if(event.origin !== \'http://vxlpay.appspotlocal.com\') return;
	...
	*/
	...
	function output($setting) {
       ...
       function error($funcname, $message, $data = null) {
        ...
        $wpdb->insert( $wpdb->prefix.'vxlpay_error', array("context"=>'public', "funcName" => $funcName, "message" => $message, "data"=>$data ));
    ...
    function log($funcName, $message, $data = null) {
        ...
        $wpdb->insert( $wpdb->prefix.'vxlpay_log', array("context"=>'public', "funcName" => $funcName, "message" => $message, "data"=>$data ));
